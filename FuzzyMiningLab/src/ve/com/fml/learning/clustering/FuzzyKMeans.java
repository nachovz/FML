...
public class FuzzyKMeans implements Clusterer {
     ...
     */
    public FuzzyKMeans(int clusters, int iterations) {
     ...
     */
    public FuzzyKMeans(int clusters, int iterations, DistanceMeasure dm) {
